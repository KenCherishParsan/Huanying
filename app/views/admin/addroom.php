...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL . PUBLIC_DIR; ?>/admin/css/reg.css" type="text/css">
...
<body>
    <div class="container">
        <div class="well">
            ...
            <hr>
            <form action="<?php echo site_url('Admin/addroom'); ?>" method="post" name="room_category">
               ...
               <br>
                <div id="click_here">
                    <a href="../admin.php"><h3>Back to Admin Panel</a></h3>
                </div>
